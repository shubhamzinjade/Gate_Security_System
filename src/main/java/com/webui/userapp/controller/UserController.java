package com.webui.userapp.controller;

import com.webui.userapp.model.User;
import com.webui.userapp.repository.UserRepository;
...
public class UserController {
    ...
    public ResponseEntity<User> updateUser(@PathVariable(value = "id") Long id, @Valid @RequestBody User userDetails) {
        ...
        user.setVisit(userDetails.getVisit());
        user.setVehicle(userDetails.getVehicle());
